            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full border bg-red-500 text-white flex justify-center items-center hover:bg-transparent hover:border hover:border-red-600 hover:text-red-600 dark:hover:bg-white dark:hover:border-0 transition-colors duration-300"
                >
                  {link.icon}
                </a>
              ))}
